      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center" data-aos="zoom-in">
        <div className="bg-gray-50 border border-gray-100 rounded-3xl p-6 sm:p-10 md:p-12 shadow-sm">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            <a
              id="cta-whatsapp"
              href="https://wa.me/917075555987?text=Hello%20Decor%20Dazzlers!%20I%20want%20to%20consult%20for%20a%20decoration%20theme%20setup."
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-2 bg-[#25D366] hover:bg-[#1ebe5d] text-white px-8 py-3 rounded-full font-sans text-xs font-bold tracking-wider uppercase transition-all duration-300 shadow-sm hover:shadow-md w-full sm:w-auto"
            >
